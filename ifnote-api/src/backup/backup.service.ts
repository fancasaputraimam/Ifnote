        ...
        try {
          await this.prisma.kotoba.create({
            data: {
              ...
              readingRuby: typeof row.readingRuby === "string" ? row.readingRuby : null,
              ...
              beginnerExampleReading: typeof row.beginnerExampleReading === "string" ? row.beginnerExampleReading : null,
              beginnerExampleMeaning: typeof row.beginnerExampleMeaning === "string" ? row.beginnerExampleMeaning : null,
              normalExample: typeof row.normalExample === "string" ? row.normalExample : null,
              normalExampleReading: typeof row.normalExampleReading === "string" ? row.normalExampleReading : null,
              normalExampleMeaning: typeof row.normalExampleMeaning === "string" ? row.normalExampleMeaning : null,
              furiganaExample: typeof row.furiganaExample === "string" ? row.furiganaExample : null,
              exampleReading: typeof row.exampleReading === "string" ? row.exampleReading : null,
